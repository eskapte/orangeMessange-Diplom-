...
import {hideChat, openUserSidebar, setFullUser} from "../../../redux/actions";
...
function UserHead(props) {
    ...
    function closeUserChat(e) {
        ...
        let chats = chatList.getElementsByTagName("li");
        chats[props.active_user].classList.remove('active');
                                ...
                                <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                                    ...
                                    <DropdownMenu className="p-0 dropdown-menu-end dropdown-menu-md">
                                        <div className="search-box p-2">
                                            <Input type="text" className="form-control bg-light border-0" placeholder="Поиск..." />
                                        </div>
                                    </DropdownMenu>
                                </Dropdown>
                            </li>
