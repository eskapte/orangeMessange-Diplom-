            ...
            <div className="p-3 p-lg-4 border-top mb-0">
                <Form onSubmit={(e) => onaddMessage(e, textMessage)} >
                    <Row noGutters>
                        <Col>
                            <div>
                                <Input type="text" value={textMessage} onChange={handleChange} className="form-control form-control-lg bg-light border-light" placeholder="Введите сообщение..." onKeyDown={(e) => sendMessage(e)}/>
                            </div>
                        </Col>
                        <Col xs="auto">
